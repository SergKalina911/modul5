...
або list comprehensions, для більш складних умов перевірки. 
    ...
    Функція all() є вбудованою функцією, яка повертає True, якщо всі елементи в переданому їй об'єкті ітерації 
    є істинними - тобто не False, 0, "", None або будь-яке інше значення, яке Python оцінює як хибне. Але будьте уважні, 
...
""" Код поверне True, оскільки всі елементи в списку nums є істинними значеннями.
...
# Код виведе True, оскільки всі слова починаються з великої літери.

""" Функція all() є корисним інструментом, коли потрібно перевірити, чи вся колекція даних відповідає певним вимогам 
або умовам, наприклад, всі елементи є істинними, всі числа є парними, всі рядки відповідають певному формату тощо. 
Це забезпечує елегантний спосіб перевірити умови, які застосовуються до всіх елементів об'єкта ітерації, замість 
використання циклів або більш складних конструкцій.
    Загалом, використання функцій any(), all(), map(), filter() і технік comprehensions забезпечує більш чистий, 
лаконічний та ефективний код, особливо при роботі з даними та колекціями. """
